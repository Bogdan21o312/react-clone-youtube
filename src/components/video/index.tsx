                ...
                <div key={index} className={classes.videoBox}>
                    ...
                    <div className={classes.videoInfo}>
                        ...
                        <div className={classes.videoInfoBox}>
                            ...
                            <h3 className={classes.videoInfoBoxSubTitle} title={videos.channel}>{videos.channel} {videos.isVerified &&
                                <span className={`${classes.active}`}>check_circle</span>}</h3>
                            <p className={classes.videoInfoBoxText}>{countViews(videos.views)} views • {videos.uploadTime} ago</p>
                        </div>
                    </div>
                </div>
            )}
